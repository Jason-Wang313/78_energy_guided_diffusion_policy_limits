...
This repository contains a hardened, honest workshop-only robotics paper draft for `energy_guided_diffusion_policy_limits`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/78.pdf`
