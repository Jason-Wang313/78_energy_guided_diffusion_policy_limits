...
1. Chosen thesis: Energy-Guided Diffusion Policy Limits explores `Identify when energy guidance changes reachable behavior rather than only re-ranking samples.` for diffusion and energy-based robot policies.
...
8. Exact Downloads PDF path: `C:/Users/wangz/Downloads/78.pdf`
9. GitHub URL: https://github.com/Jason-Wang313/78_energy_guided_diffusion_policy_limits
